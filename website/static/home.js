...
function updateInterestedCarparkUI() {
  ...
  const newInterestCarparkItem = createCarparksListItemUI(storedInterestedCarpark, true, "interested-carpark-list-item");
...
async function updateRouteUI() {
  try {
    ...
    const toCoordinates = storedInterestedCarpark.geometry.coordinates;
...
colorBlindModeBtn.addEventListener("click", function () {
    ...
    map.removeLayer("carparks-layer");
